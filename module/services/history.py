...
from .merge import enqueue_merge_task
...
def find_history_entry(output_name: str) -> dict[str, Any] | None:
    for entry in load_history():
...
def get_history_entry(output_name: str) -> dict[str, Any]:
...
def import_recipe_yaml(yaml_text: str) -> dict[str, Any]:
